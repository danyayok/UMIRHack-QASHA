    ...
    def _create_test_generation_prompt(self, test_type: str, framework: str, config: Dict) -> str:
        ...
        if test_type == "api":
            ...
            base_prompt += f"""
                ...
                - Проверяй навигацию между страницами/экранами
                - Тестируй взаимодействие с backend API
                ...
                - Используй реальные тестовые данные
                - Симулируй разные пользовательские роли если нужно
                - Проверяй responsive design на разных размерах экранов
                - Тестируй accessibility (a11y) если возможно

                ## 🛠️ ФРЕЙМВОРКИ ДЛЯ E2E:
                - Playwright (рекомендуется): современный, надежный
                - Cypress: популярный, хорошая документация  
                - Selenium: универсальный, но более медленный
